...
import { CompressedScreenshotResponse, RegionScreenshotResponse } from '@northrays/api-client'
import { ComputerUse, ScreenshotRegion } from '@northrays/sdk'
import { ScreenshotResponse } from '@northrays/toolbox-api-client'
