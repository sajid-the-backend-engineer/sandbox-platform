---
title: VNC Access
description: Interact with your sandbox's graphical desktop environment directly in the browser.
---

import { TabItem, Tabs } from '@astrojs/starlight/components'

VNC (Virtual Network Computing) access provides a graphical desktop environment for your Northrays Sandbox directly in the browser. This allows you to interact with GUI applications, desktop tools, and visual interfaces running inside your sandbox.
...
Access the VNC desktop environment directly from the [Northrays Dashboard ↗](https://app.northrays.com/dashboard/sandboxes).
...
Northrays provides methods to [start](#start-vnc), [stop](#stop-vnc), and [monitor](#get-vnc-status) VNC sessions and processes programmatically using the [Computer Use](/docs/en/computer-use) references as part of automated workflows.
...
# Type a URL
sandbox.computer_use.keyboard.type("https://www.northrays.com/docs/")
...
// Type a URL
await sandbox.computerUse.keyboard.type('https://www.northrays.com/docs/');
...
// Type a URL
sandbox.computerUse.typeText("https://www.northrays.com/docs/");
