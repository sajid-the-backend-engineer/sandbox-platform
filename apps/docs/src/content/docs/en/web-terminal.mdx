---
title: Web Terminal
description: Interact with your sandboxes using a browser-based web terminal.
---

import { TabItem, Tabs } from '@astrojs/starlight/components'

Northrays provides a browser-based web terminal for interacting with your sandboxes. The web terminal allows you to run commands, view files, and debug directly from your browser without installing any local tools.
...
Access the web terminal directly from the [Northrays Dashboard ↗](https://app.northrays.com/dashboard/sandboxes).
...
When you create a sandbox using the Northrays CLI, the web terminal URL is displayed automatically in the output.
...
```bash
northrays preview-url <sandbox-name> --port 22222
```
...
```bash
curl 'https://app.northrays.com/api/sandbox/{sandboxId}/ports/22222/preview-url' \
