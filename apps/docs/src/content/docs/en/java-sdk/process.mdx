...
- `NorthraysException` - if execution fails
...
- `NorthraysException` - if session creation fails
...
- `NorthraysException` - if retrieval fails
...
- `NorthraysException` - if streaming fails
...
- `NorthraysException` - if sending input fails
...
- `NorthraysException` - if listing fails
...
- `NorthraysException` - if PTY session creation fails
...
- `NorthraysException` - if websocket connection setup fails
...
- `NorthraysException` - if resize fails
...
- `NorthraysException` - if termination fails
