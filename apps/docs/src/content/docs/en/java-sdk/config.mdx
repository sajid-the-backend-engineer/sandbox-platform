---
title: "NorthraysConfig"
hideTitleOnPage: true
---

## NorthraysConfig

Configuration used to initialize a `Northrays` client.
...
## NorthraysConfig.Builder

Builder for creating immutable `NorthraysConfig` instances.
...
- `apiKey` _String_ - Northrays API key
...
- `apiUrl` _String_ - API URL to use; defaults to `https://app.northrays.com/api` when omitted
...
Builds a new immutable `NorthraysConfig`.

**Returns**:

- `NorthraysConfig` - configured `NorthraysConfig` instance
