...
- `io.northrays.sdk.exception.NorthraysException` - if creation fails
...
- `io.northrays.sdk.exception.NorthraysException` - if deletion fails
...
- `io.northrays.sdk.exception.NorthraysException` - if download or local read fails
...
- `io.northrays.sdk.exception.NorthraysException` - if the file does not exist or access is denied
...
- `io.northrays.sdk.exception.NorthraysException` - if download fails
...
- `io.northrays.sdk.exception.NorthraysException` - if upload fails
...
- `io.northrays.sdk.exception.NorthraysException` - if listing fails
...
- `io.northrays.sdk.exception.NorthraysException` - if lookup fails
...
- `io.northrays.sdk.exception.NorthraysException` - if the search request fails
...
- `io.northrays.sdk.exception.NorthraysException` - if replacement fails
...
- `io.northrays.sdk.exception.NorthraysException` - if move fails
