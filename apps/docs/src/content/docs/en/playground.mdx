---
title: Playground
description: Create sandboxes, run SDK operations, and explore Northrays features directly from your browser.
---

Northrays provides an interactive environment ("Playground") for creating sandboxes, running SDK operations, and exploring Northrays features directly from your browser.
...
Navigate to [Northrays Dashboard ↗](https://app.northrays.com/dashboard/playground) to access the playground.
