...
LspServer class for Northrays SDK.
...
- `toolbox_api` _NorthraysToolboxApiClient:LspApi_ -
- `sandbox_id` _String_ -
...
- `NorthraysToolboxApiClient:LspApi`
...
- `path` _String_ -
- `position` _Northrays:LspServer:Position_ -

**Returns**:

- `NorthraysApiClient:CompletionList`
...
- `Array\<NorthraysToolboxApiClient:LspSymbol]`
