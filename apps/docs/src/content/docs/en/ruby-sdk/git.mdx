...
- `toolbox_api` _NorthraysToolboxApiClient:GitApi_ - API client for Sandbox operations.
...
- `NorthraysToolboxApiClient:GitApi` - API client for Sandbox operations
...
- `Northrays:Sdk:Error` - if adding files fails
...
- `NorthraysApiClient:ListBranchResponse` - List of branches in the repository.

**Raises**:

- `Northrays:Sdk:Error` - if listing branches fails
...
- `Northrays:Sdk:Error` - if cloning repository fails
...
- `Northrays:Sdk:Error` - if committing changes fails
...
- `Northrays:Sdk:Error` - if pushing changes fails
...
- `Northrays:Sdk:Error` - if pulling changes fails
...
- `NorthraysToolboxApiClient:GitStatus` - Repository status information including:

**Raises**:

- `Northrays:Sdk:Error` - if getting status fails
...
- `Northrays:Sdk:Error` - if checking out branch fails
...
- `Northrays:Sdk:Error` - if creating branch fails
...
- `Northrays:Sdk:Error` - if deleting branch fails
