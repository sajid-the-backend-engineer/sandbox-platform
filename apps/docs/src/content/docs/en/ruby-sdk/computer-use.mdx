...
- `toolbox_api` _NorthraysApiClient:ToolboxApi_ - API client for sandbox operations
...
- `NorthraysApiClient:ToolboxApi` - API client for sandbox operations
...
- `NorthraysApiClient:ComputerUseStartResponse` - Computer use start response

**Raises**:

- `Northrays:Sdk:Error` - If the operation fails
...
- `NorthraysApiClient:ComputerUseStopResponse` - Computer use stop response
...
- `NorthraysApiClient:ComputerUseStatusResponse` - Status information about all VNC desktop processes
...
- `NorthraysApiClient:ProcessStatusResponse` - Status information about the specific process
...
- `NorthraysApiClient:ProcessRestartResponse` - Process restart response
...
- `NorthraysApiClient:ProcessLogsResponse` - Process logs
...
- `NorthraysApiClient:ProcessErrorsResponse` - Process error logs
...
- `sandbox_id` _String_ - The ID of the sandbox
- `toolbox_api` _NorthraysToolboxApiClient:ComputerUseApi_ - API client for sandbox operations
- `otel_state` _Northrays:OtelState, nil_ -
...
- `NorthraysToolboxApiClient:ComputerUseApi` - API client for sandbox operations
...
- `NorthraysToolboxApiClient:AccessibilityTreeResponse` - Accessibility tree response
...
- `NorthraysToolboxApiClient:AccessibilityNodesResponse` - Matching accessibility nodes
