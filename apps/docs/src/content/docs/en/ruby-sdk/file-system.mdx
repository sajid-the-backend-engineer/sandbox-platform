...
- `toolbox_api` _NorthraysToolboxApiClient:FileSystemApi_ - API client for Sandbox operations
...
- `NorthraysToolboxApiClient:FileSystemApi` - API client for Sandbox operations
...
- `NorthraysApiClient:FileInfo` - Detailed file information
...
- `Array\<NorthraysApiClient:FileInfo\>` - List of file and directory information
...
- `on_progress` _Proc, nil_ - Optional callback invoked with a Northrays::DownloadProgress
...
- `Northrays:Sdk:Error` - If the file does not exist, the operation fails, or
...
- `Northrays:Sdk:Error` - If the operation fails or +cancel_event+ is set.
...
- `Array\<NorthraysApiClient:Match\>` - List of matches found in files
...
- `NorthraysApiClient:SearchFilesResponse`
...
- `Array\<NorthraysApiClient:ReplaceResult\>` - List of results indicating replacements made in each file
