---
title: 監査ログ
description: Northrays の組織全体にわたるすべてのユーザー操作を表示および監視します。
---

Northrays の監査ログは、組織全体のユーザーおよびシステムのアクティビティを詳細に記録します。サンドボックスのライフサイクルイベント、ユーザーアクセス、システム変更などの追跡にご利用ください。

[Dashboard](https://app.northrays.com/dashboard/audit-logs) から監査ログにアクセスできます。
...
以下は、Northrays によって記録されるアクションの全一覧です：
