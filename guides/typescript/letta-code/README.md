...
This example runs a Letta Code agent inside a Northrays sandbox. You can interact with the agent via the CLI to run automations, build apps, and launch web apps or services using [Northrays preview links](https://www.northrays.com/docs/en/preview-and-authentication/#fetching-a-preview-link).
...
3. Letta code is launched in [bidirectional headless mode](https://docs.letta.com/letta-code/headless#bidirectional-mode) with a Northrays-specific system prompt.
...
🔧 TodoWrite
🔧 Write /home/northrays/workspace/index.html
🔧 TodoWrite
...
Play the game here: https://8000-1a1ebb4b-e521-4881-87bf-494777570a8a.proxy.northrays.works
