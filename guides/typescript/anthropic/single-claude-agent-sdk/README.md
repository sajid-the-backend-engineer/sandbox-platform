...
This example runs a coding agent with the capabilities of Claude Code inside a Northrays sandbox. You can interact with the agent via the CLI to run automations, build apps, and launch web apps or services using [Northrays preview links](https://www.northrays.com/docs/en/preview-and-authentication/#fetching-a-preview-link).
...
The server is serving the files from /home/northrays/. Click the link above to start playing!
