...
def main():
    ...
    sandbox2 = northrays.create(params=CreateSandboxFromSnapshotParams(network_block_all=True))
    ...
    sandbox3 = northrays.create(params=CreateSandboxFromSnapshotParams(network_allow_list="192.168.1.0/16,10.0.0.0/24"))
