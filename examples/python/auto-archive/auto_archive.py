...
def main():
    ...
    # Max interval
    sandbox2 = northrays.create(params=CreateSandboxFromSnapshotParams(auto_archive_interval=0))
    print(sandbox2.auto_archive_interval)

    # 1 day interval
    sandbox3 = northrays.create(params=CreateSandboxFromSnapshotParams(auto_archive_interval=1440))
