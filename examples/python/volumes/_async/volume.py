...
from northrays import AsyncNorthrays, CreateSandboxFromSnapshotParams, VolumeMount


async def main():
    async with AsyncNorthrays() as northrays:
        # Create a new volume or get an existing one
        volume = await northrays.volume.get("my-volume", create=True)
        ...
        sandbox = await northrays.create(params)
        ...
        sandbox2 = await northrays.create(params)
        ...
        sandbox3 = await northrays.create(params)
