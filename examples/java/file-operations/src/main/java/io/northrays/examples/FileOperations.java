...
import io.northrays.sdk.DownloadStreamOptions;
import io.northrays.sdk.Sandbox;
import io.northrays.sdk.UploadStreamOptions;
    ...
    public static void main(String[] args) {
        try (Northrays northrays = new Northrays()) {
            ...
            try {
                ...
                sandbox.getFs().uploadFile("Hello, Northrays!".getBytes(StandardCharsets.UTF_8), "test-dir/hello.txt");
