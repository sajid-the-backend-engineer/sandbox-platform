...
from northrays_api_client import BuildInfo, CreateSandboxSnapshot, ForkSandbox, PortPreviewUrl, ResizeSandbox
from northrays_api_client import Sandbox as SandboxDto
from northrays_api_client import (
    SandboxApi,
    SandboxLabels,
    SandboxListItem,
    SandboxState,
...
from northrays_toolbox_api_client import (
    ApiClient,
    ComputerUseApi,
    FileSystemApi,
    GitApi,
...
class Sandbox(SandboxDto):
    ...
    def _experimental_fork(self, name: str | None = None, timeout: float | None = 60) -> "Sandbox":
        ...
        Example:
            ```python
            sandbox = northrays.get("my-sandbox")
