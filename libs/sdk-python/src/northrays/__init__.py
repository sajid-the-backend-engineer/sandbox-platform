...
if TYPE_CHECKING:
    from northrays_api_client import SandboxListSortDirection, SandboxListSortField, SandboxState
    from northrays_api_client_async import GpuType, SandboxClass
    from northrays_toolbox_api_client import SessionExecuteResponse

    from ._async.computer_use import AsyncComputerUse, AsyncDisplay, AsyncKeyboard, AsyncMouse, AsyncScreenshot
    from ._async.northrays import AsyncNorthrays
    from ._async.sandbox import AsyncSandbox
    from ._sync.northrays import Northrays
...
_EXTERNAL_IMPORTS: dict[str, tuple[str, str]] = {
    "GpuType": ("northrays_api_client_async.models.gpu_type", "GpuType"),
    "SandboxClass": ("northrays_api_client_async.models.sandbox_class", "SandboxClass"),
    "SandboxState": ("northrays_api_client.models.sandbox_state", "SandboxState"),
    "SandboxListSortField": ("northrays_api_client.models.sandbox_list_sort_field", "SandboxListSortField"),
    "SandboxListSortDirection": (
...
_DYNAMIC_IMPORTS: dict[str, str] = {
    # _sync
    "Northrays": "_sync.northrays",
    "Sandbox": "_sync.sandbox",
    # _async
    "AsyncNorthrays": "_async.northrays",
    ...
    # common.northrays
    "CodeLanguage": "common.northrays",
    "CreateSandboxBaseParams": "common.northrays",
    "CreateSandboxFromImageParams": "common.northrays",
    "CreateSandboxFromSnapshotParams": "common.northrays",
    "NorthraysConfig": "common.northrays",
    # common.errors
    "NorthraysError": "common.errors",
    "NorthraysNotFoundError": "common.errors",
    "NorthraysRateLimitError": "common.errors",
    "NorthraysTimeoutError": "common.errors",
    "NorthraysAuthenticationError": "common.errors",
    "NorthraysAuthorizationError": "common.errors",
    "NorthraysConflictError": "common.errors",
    "NorthraysValidationError": "common.errors",
    "NorthraysConnectionError": "common.errors",
    # common.filesystem
