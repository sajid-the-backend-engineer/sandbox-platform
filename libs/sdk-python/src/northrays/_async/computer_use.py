...
class AsyncKeyboard:
    ...
    async def type(self, text: str, delay: int | None = None) -> None:
        ...
        Raises:
            NorthraysError: If the type operation fails.
    ...
    async def press(self, key: str, modifiers: list[str] | None = None) -> None:
        ...
        Raises:
            NorthraysError: If the press operation fails.
    ...
    async def hotkey(self, keys: str) -> None:
        ...
        Raises:
            NorthraysError: If the hotkey operation fails.
...
class AsyncAccessibility:
    ...
    async def focus_node(self, node_id: str) -> None:
        ...
        Raises:
            NorthraysError: If the focus operation fails. API failures may use a more specific subclass.
    ...
    async def invoke_node(self, node_id: str, action: str | None = None) -> None:
        ...
        Raises:
            NorthraysError: If the invoke operation fails. API failures may use a more specific subclass.
    ...
    async def set_node_value(self, node_id: str, value: str) -> None:
        ...
        Raises:
            NorthraysError: If the value update fails. API failures may use a more specific subclass.
