...
module Northrays
  ...
  def self.init_otel(sdk_version) # rubocop:disable Metrics/MethodLength
    ...
    resource = OpenTelemetry::SDK::Resources::Resource.create(
      'service.name' => 'northrays-ruby-sdk',
    ...
    tracer = tracer_provider.tracer('northrays-ruby-sdk', sdk_version)
    meter = meter_provider.meter('northrays-ruby-sdk')
      ...
      def instrument(*method_names, component:) # rubocop:disable Metrics/MethodLength
        method_names.each do |method_name|
          ...
          define_method(method_name) do |*args, **kwargs, &blk|
            ::Northrays.with_instrumentation(otel_state, component, method_name.to_s) do
