...
module Northrays
  class CreateSnapshotParams
    ...
    # @return [String, Northrays::Image] Image of the snapshot. If a string is provided,
    #   it should be available on some registry. If an Image instance is provided,
    #   it will be used to create a new image in Northrays.
    attr_reader :image

    # @return [Northrays::Resources, nil] Resources of the snapshot
    ...
    # @return [NorthraysApiClient::SandboxClass, nil] Target sandbox class.
    attr_reader :sandbox_class

    # @param name [String] Name of the snapshot
    # @param image [String, Northrays::Image] Image of the snapshot
    # @param resources [Northrays::Resources, nil] Resources of the snapshot
    ...
    # @param sandbox_class [NorthraysApiClient::SandboxClass, nil] Target sandbox class
  ...
  class Snapshot
    ...
    # @return [NorthraysApiClient::BuildInfo, nil] Build information for the snapshot
    attr_reader :build_info

    # @param snapshot_dto [NorthraysApiClient::SnapshotDto] The snapshot DTO from the API
    ...
    #
    # @param dto [NorthraysApiClient::SnapshotDto] The snapshot DTO from the API
    # @return [Northrays::Snapshot] The snapshot instance
