...
module Northrays
  ChartElement = NorthraysToolboxApiClient::ChartElement
  ...
  module Charts
    Chart = Northrays::Chart
    ChartElement = Northrays::ChartElement
    ChartType = Northrays::ChartType
    LineChart = Northrays::LineChart
    ScatterChart = Northrays::ScatterChart
    BarChart = Northrays::BarChart
    PieChart = Northrays::PieChart
    BoxAndWhiskerChart = Northrays::BoxAndWhiskerChart
    CompositeChart = Northrays::CompositeChart
    PointData = Northrays::PointData
    BarData = Northrays::BarData
    PieData = Northrays::PieData
    BoxAndWhiskerData = Northrays::BoxAndWhiskerData
