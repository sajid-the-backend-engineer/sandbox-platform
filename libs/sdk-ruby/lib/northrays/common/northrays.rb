...
module Northrays
  ...
  class CreateSandboxBaseParams
    ...
    # @return [Array<NorthraysApiClient::SandboxVolume>, nil] List of volumes mounts to attach to the Sandbox
    ...
    # @param volumes [Array<NorthraysApiClient::SandboxVolume>, nil] List of volumes mounts to attach to the Sandbox
  ...
  class CreateSandboxFromImageParams < CreateSandboxBaseParams
    ...
    # @return [Northrays::Resources, nil] Resource configuration for the Sandbox. If not provided, sandbox will
    ...
    # @param resources [Northrays::Resources, nil] Resource configuration for the Sandbox
    # @param language [Symbol, nil] Programming language for the Sandbox
    # @param os_user [String, nil] OS user for the Sandbox
    # @param env_vars [Hash<String, String>, nil] Environment variables to set in the Sandbox
    # @param labels [Hash<String, String>, nil] Custom labels for the Sandbox
