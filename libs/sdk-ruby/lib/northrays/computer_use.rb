...
module Northrays
  class ComputerUse
    class Mouse
      ...
      # @return [NorthraysToolboxApiClient::ComputerUseApi] API client for sandbox operations
      attr_reader :toolbox_api

      # @param sandbox_id [String] The ID of the sandbox
      # @param toolbox_api [NorthraysToolboxApiClient::ComputerUseApi] API client for sandbox operations
      ...
      #
      # @return [NorthraysToolboxApiClient::MousePosition] Current mouse position with x and y coordinates
      # @raise [Northrays::Sdk::Error] If the operation fails
      #
      # @example
      ...
      # @return [NorthraysToolboxApiClient::MouseMoveResponse] Move operation result
      # @raise [Northrays::Sdk::Error] If the operation fails
      #
      # @example
      ...
      def move(x:, y:)
        request = NorthraysToolboxApiClient::MouseMoveRequest.new(x:, y:)
      ...
      # @return [NorthraysToolboxApiClient::MouseClickResponse] Click operation result
      # @raise [Northrays::Sdk::Error] If the operation fails
      #
      # @example
      #   # Single left click
      ...
      def click(x:, y:, button: 'left', double: false)
        request = NorthraysToolboxApiClient::MouseClickRequest.new(x:, y:, button:, double:)
      ...
      # @return [NorthraysToolboxApiClient::MouseDragResponse] Drag operation result
      # @raise [Northrays::Sdk::Error] If the operation fails
      #
      # @example
      ...
      def drag(start_x:, start_y:, end_x:, end_y:, button: 'left')
        request = NorthraysToolboxApiClient::MouseDragRequest.new(start_x:, start_y:, end_x:, end_y:, button:)
      ...
      def scroll(x:, y:, direction:, amount: 1)
        request = NorthraysToolboxApiClient::MouseScrollRequest.new(x:, y:, direction:, amount:)
    ...
    class Keyboard
      ...
      def type(text:, delay: nil)
        request = NorthraysToolboxApiClient::KeyboardTypeRequest.new(text:, delay:)
      ...
      def press(key:, modifiers: nil)
        request = NorthraysToolboxApiClient::KeyboardPressRequest.new(key:, modifiers: modifiers || [])
      ...
      def hotkey(keys:)
        request = NorthraysToolboxApiClient::KeyboardHotkeyRequest.new(keys:)
    ...
    class Screenshot
      ...
      # @return [NorthraysApiClient::ScreenshotResponse] Screenshot data with base64 encoded image
      # @raise [Northrays::Sdk::Error] If the operation fails
      #
      # @example
      ...
      # @param show_cursor [Boolean] Whether to show the cursor in the screenshot. Defaults to false
      # @return [NorthraysApiClient::RegionScreenshotResponse] Screenshot data with base64 encoded image
      # @raise [Northrays::Sdk::Error] If the operation fails
      #
      # @example
      ...
      # @return [NorthraysApiClient::CompressedScreenshotResponse] Compressed screenshot data
      # @raise [Northrays::Sdk::Error] If the operation fails
      #
      # @example
      #   # Default compression
    ...
    class Display
      ...
      #
      # @return [NorthraysToolboxApiClient::DisplayInfoResponse] Display information including primary display and all available displays
      # @raise [Northrays::Sdk::Error] If the operation fails
      #
      # @example
      ...
      #
      # @return [NorthraysToolboxApiClient::WindowsResponse] List of open windows with their IDs and titles
      # @raise [Northrays::Sdk::Error] If the operation fails
      #
      # @example
    ...
    class Accessibility
      ...
      # @return [NorthraysToolboxApiClient::AccessibilityTreeResponse] Accessibility tree response
      # @raise [Northrays::Sdk::Error] If the operation fails
      #
      # @example
      ...
      # @return [NorthraysToolboxApiClient::AccessibilityNodesResponse] Matching accessibility nodes
      # @raise [Northrays::Sdk::Error] If the operation fails
      #
      # @example
      ...
      def find_nodes(scope: nil, pid: nil, role: nil, name: nil, name_match: nil, states: nil, limit: nil)
        ...
        request = NorthraysToolboxApiClient::FindAccessibilityNodesRequest.new(attrs)
      ...
      def focus_node(id:)
        request = NorthraysToolboxApiClient::AccessibilityNodeRequest.new(id:)
      ...
      def invoke_node(id:, action: nil)
        ...
        request = NorthraysToolboxApiClient::AccessibilityInvokeRequest.new(attrs)
      ...
      def set_node_value(id:, value:)
        request = NorthraysToolboxApiClient::AccessibilitySetValueRequest.new(id:, value:)
    ...
    class Recording
      ...
      # @return [NorthraysToolboxApiClient::Recording] Started recording details
      # @raise [Northrays::Sdk::Error] If the operation fails
      #
      # @example
      ...
      def start(label: nil)
        request = NorthraysToolboxApiClient::StartRecordingRequest.new(label:)
      ...
      # @return [NorthraysToolboxApiClient::Recording] Stopped recording details
      # @raise [Northrays::Sdk::Error] If the operation fails
      #
      # @example
      ...
      def stop(id:)
        request = NorthraysToolboxApiClient::StopRecordingRequest.new(id: id)
      ...
      #
      # @return [NorthraysToolboxApiClient::ListRecordingsResponse] List of all recordings
      # @raise [Northrays::Sdk::Error] If the operation fails
      #
      # @example
      ...
      # @return [NorthraysToolboxApiClient::Recording] Recording details
      # @raise [Northrays::Sdk::Error] If the operation fails
      #
      # @example
    ...
    # @return [NorthraysApiClient::ToolboxApi] API client for sandbox operations
    attr_reader :toolbox_api
    ...
    #
    # @param sandbox_id [String] The ID of the sandbox
    # @param toolbox_api [NorthraysApiClient::ToolboxApi] API client for sandbox operations
    # @param otel_state [Northrays::OtelState, nil]
    def initialize(sandbox_id:, toolbox_api:, otel_state: nil)
      @sandbox_id = sandbox_id
      @toolbox_api = toolbox_api
    ...
    #
    # @return [NorthraysApiClient::ComputerUseStartResponse] Computer use start response
    # @raise [Northrays::Sdk::Error] If the operation fails
    #
    # @example
    ...
    #
    # @return [NorthraysApiClient::ComputerUseStopResponse] Computer use stop response
    # @raise [Northrays::Sdk::Error] If the operation fails
    #
    # @example
    ...
    #
    # @return [NorthraysApiClient::ComputerUseStatusResponse] Status information about all VNC desktop processes
    # @raise [Northrays::Sdk::Error] If the operation fails
    #
    # @example
    ...
    # @return [NorthraysApiClient::ProcessStatusResponse] Status information about the specific process
    # @raise [Northrays::Sdk::Error] If the operation fails
    #
    # @example
    ...
    # @return [NorthraysApiClient::ProcessRestartResponse] Process restart response
    # @raise [Northrays::Sdk::Error] If the operation fails
    #
    # @example
    ...
    # @return [NorthraysApiClient::ProcessLogsResponse] Process logs
    # @raise [Northrays::Sdk::Error] If the operation fails
    #
    # @example
    ...
    # @return [NorthraysApiClient::ProcessErrorsResponse] Process error logs
    # @raise [Northrays::Sdk::Error] If the operation fails
    #
    # @example
