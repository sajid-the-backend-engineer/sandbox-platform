...
module Northrays
  ...
  class CodeInterpreter
    ...
    # @param toolbox_api [NorthraysToolboxApiClient::InterpreterApi]
    ...
    # @param context [NorthraysToolboxApiClient::InterpreterContext, nil] Context to run code in
    ...
    # @return [Northrays::ExecutionResult]
    ...
    # @return [NorthraysToolboxApiClient::InterpreterContext]
    # @raise [Northrays::Sdk::Error]
    #
    # @example
    ...
    def create_context(cwd: nil)
      request = NorthraysToolboxApiClient::CreateContextRequest.new(cwd:)
    ...
    #
    # @return [Array<NorthraysToolboxApiClient::InterpreterContext>]
    # @raise [Northrays::Sdk::Error]
    #
    # @example
    ...
    #
    # @param context [NorthraysToolboxApiClient::InterpreterContext]
    # @return [void]
    # @raise [Northrays::Sdk::Error]
    #
    # @example
    ...
    # @param data [String]
    # @param result [Northrays::ExecutionResult]
