...
final class TestSupport {
    ...
    static io.northrays.api.client.model.Sandbox mainSandbox(String id, SandboxState state) {
        io.northrays.api.client.model.Sandbox sandbox = new io.northrays.api.client.model.Sandbox();
        sandbox.setId(id);
        sandbox.setOrganizationId("org-1");
        sandbox.setName("sandbox-" + id);
        sandbox.setUser("northrays");
    ...
    static io.northrays.api.client.model.Sandbox sandboxWithToolboxUrl(String id, SandboxState state, String toolboxUrl) {
        io.northrays.api.client.model.Sandbox sandbox = mainSandbox(id, state);
        sandbox.setToolboxProxyUrl(toolboxUrl);
        return sandbox;
    }

    static io.northrays.api.client.model.SandboxListItem mainSandboxListItem(String id, SandboxState state) {
        io.northrays.api.client.model.SandboxListItem sandbox = new io.northrays.api.client.model.SandboxListItem();
        sandbox.setId(id);
        sandbox.setOrganizationId("org-1");
        sandbox.setName("sandbox-" + id);
        sandbox.setUser("northrays");
    ...
    static NorthraysConfig config() {
        return new NorthraysConfig.Builder()
                .apiKey("test-key")
