...
public class ExecuteResponse extends io.northrays.toolbox.client.model.ExecuteResponse {
    private CodeRunArtifacts artifacts;

    public ExecuteResponse() {}

    public ExecuteResponse(io.northrays.toolbox.client.model.ExecuteResponse source) {
        super();
        if (source != null) {
