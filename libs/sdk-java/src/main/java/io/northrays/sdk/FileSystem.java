...
import io.northrays.sdk.model.FileInfo;
...
public class FileSystem {
     ...
     * @throws io.northrays.sdk.exception.NorthraysException if download or local read fails
     */
    public byte[] downloadFile(String remotePath) {
        ...
        try {
            ...
            throw new io.northrays.sdk.exception.NorthraysException("Failed to read downloaded file", e);
        }
    }
     ...
     * @throws io.northrays.sdk.exception.NorthraysException if the file does not exist or access is denied
     */
    public InputStream downloadFileStream(String remotePath) throws io.northrays.sdk.exception.NorthraysException {
     ...
     * @throws io.northrays.sdk.exception.NorthraysException if the file does not exist or access is denied
     */
    public InputStream downloadFileStream(String remotePath, int timeoutSeconds) throws io.northrays.sdk.exception.NorthraysException {
     ...
     * @throws io.northrays.sdk.exception.NorthraysException if download fails
     */
    public InputStream downloadFileStream(String remotePath, DownloadStreamOptions options) throws io.northrays.sdk.exception.NorthraysException {
     ...
     * @throws io.northrays.sdk.exception.NorthraysException if upload fails
     */
    public void uploadFile(byte[] content, String remotePath) {
        try {
            File tempFile = File.createTempFile("northrays-upload-", ".tmp");
            ...
            throw new io.northrays.sdk.exception.NorthraysException("Failed to upload file", e);
        }
    }
     ...
     * @throws io.northrays.sdk.exception.NorthraysException if listing fails
     */
    public List<FileInfo> listFiles(String path) {
        List<io.northrays.toolbox.client.model.FileInfo> files = ExceptionMapper.callToolbox(() -> fileSystemApi.listFiles(path));
        List<FileInfo> result = new ArrayList<FileInfo>();
        if (files != null) {
            for (io.northrays.toolbox.client.model.FileInfo file : files) {
     ...
     * @throws io.northrays.sdk.exception.NorthraysException if lookup fails
     */
    public FileInfo getFileDetails(String path) {
        io.northrays.toolbox.client.model.FileInfo fileInfo = ExceptionMapper.callToolbox(() -> fileSystemApi.getFileInfo(path));
     ...
     * @throws io.northrays.sdk.exception.NorthraysException if the search request fails
     */
    public List<Map<String, Object>> findFiles(String path, String pattern) {
        List<io.northrays.toolbox.client.model.Match> matches = ExceptionMapper.callToolbox(() -> fileSystemApi.findInFiles(path, pattern));
        List<Map<String, Object>> result = new ArrayList<Map<String, Object>>();
        if (matches != null) {
            for (io.northrays.toolbox.client.model.Match match : matches) {
    ...
    public Map<String, Object> searchFiles(String path, String pattern) {
        io.northrays.toolbox.client.model.SearchFilesResponse response = ExceptionMapper.callToolbox(() -> fileSystemApi.searchFiles(path, pattern));
     ...
     * @throws io.northrays.sdk.exception.NorthraysException if replacement fails
     */
     ...
     * @throws io.northrays.sdk.exception.NorthraysException if move fails
     */
