...
/**
 * Sort direction for {@link io.northrays.sdk.Northrays#list}.
 *
...
public enum SandboxListSortDirection {
    ...
    public io.northrays.api.client.model.SandboxListSortDirection toApiClient() {
        return io.northrays.api.client.model.SandboxListSortDirection.fromValue(value);
    }
}
