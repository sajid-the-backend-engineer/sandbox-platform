...
class FindAccessibilityNodesRequest(BaseModel):
    """
    FindAccessibilityNodesRequest
    """ # noqa: E501
    limit: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    name_match: Optional[StrictStr] = Field(default=None, description="\"exact\" | \"substring\" | \"regex\"", serialization_alias="nameMatch")
    pid: Optional[StrictInt] = None
    role: Optional[StrictStr] = None
    scope: Optional[StrictStr] = None
    states: Optional[List[StrictStr]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["limit", "name", "nameMatch", "pid", "role", "scope", "states"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FindAccessibilityNodesRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FindAccessibilityNodesRequest from a dict"""
        if obj is None:
            return None
