# northrays_toolbox_api_client

Northrays Daemon Toolbox API for file operations, process execution, git operations, LSP, computer use, and more.
...
```sh
pip install git+https://github.com/northrays/sandbox-platform.git
```

(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/northrays/sandbox-platform.git`)

Then import the package:

```python
import northrays_toolbox_api_client
```
...
import northrays_toolbox_api_client
from northrays_toolbox_api_client.rest import ApiException
...
with northrays_toolbox_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = northrays_toolbox_api_client.ComputerUseApi(api_client)
    request = northrays_toolbox_api_client.MouseClickRequest() # MouseClickRequest | Mouse click request
