...
public class MetricDataPoint {
  ...
  public MetricDataPoint timestamp(@javax.annotation.Nonnull String timestamp) {
  ...
  public MetricDataPoint value(@javax.annotation.Nonnull BigDecimal value) {
    this.value = value;
    return this;
  }
   ...
   * @return the MetricDataPoint instance itself
   */
  public MetricDataPoint putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.timestamp, metricDataPoint.timestamp) &&
        Objects.equals(this.value, metricDataPoint.value)&&
        Objects.equals(this.additionalProperties, metricDataPoint.additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("timestamp", "value"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("timestamp", "value"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetricDataPoint.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MetricDataPoint is not found in the empty JSON string", MetricDataPoint.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MetricDataPoint.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MetricDataPoint>() {
           ...
           public MetricDataPoint read(JsonReader in) throws IOException {
             ...
             MetricDataPoint instance = thisAdapter.fromJsonTree(jsonObj);
