...
import io.northrays.api.client.model.UserPublicKey;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("publicKeys") != null) {
        if (!jsonObj.get("publicKeys").isJsonArray()) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `publicKeys` to be an array in the JSON string but got `%s`", jsonObj.get("publicKeys").toString()));
        }
