...
public class ExecuteResponse {
  ...
  public ExecuteResponse exitCode(@javax.annotation.Nonnull BigDecimal exitCode) {
  ...
  public void setExitCode(@javax.annotation.Nonnull BigDecimal exitCode) {
    this.exitCode = exitCode;
  }


  public ExecuteResponse result(@javax.annotation.Nonnull String result) {
    this.result = result;
    return this;
  }
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("exitCode", "result"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExecuteResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExecuteResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExecuteResponse is not found in the empty JSON string", ExecuteResponse.openapiRequiredFields.toString()));
        }
      }
