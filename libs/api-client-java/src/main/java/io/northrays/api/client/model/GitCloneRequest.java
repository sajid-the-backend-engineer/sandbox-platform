...
public class GitCloneRequest {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.url, gitCloneRequest.url) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(url, path, username, password, branch, commitId, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("url", "path", "username", "password", "branch", "commit_id"));
