...
import io.northrays.api.client.model.MetricDataPoint;
...
public class MetricSeries {
  ...
  public MetricSeries metricName(@javax.annotation.Nonnull String metricName) {
  ...
  public MetricSeries dataPoints(@javax.annotation.Nonnull List<MetricDataPoint> dataPoints) {
    this.dataPoints = dataPoints;
    return this;
  }

  public MetricSeries addDataPointsItem(MetricDataPoint dataPointsItem) {
  ...
  public void setDataPoints(@javax.annotation.Nonnull List<MetricDataPoint> dataPoints) {
    this.dataPoints = dataPoints;
  }
   ...
   * @return the MetricSeries instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metricName, metricSeries.metricName) &&
        Objects.equals(this.dataPoints, metricSeries.dataPoints)&&
        Objects.equals(this.additionalProperties, metricSeries.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metricName, dataPoints, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MetricSeries
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MetricSeries.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MetricSeries' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MetricSeries> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MetricSeries.class));

       return (TypeAdapter<T>) new TypeAdapter<MetricSeries>() {
           @Override
           public void write(JsonWriter out, MetricSeries value) throws IOException {
           ...
           @Override
           public MetricSeries read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             MetricSeries instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of MetricSeries given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MetricSeries
   * @throws IOException if the JSON string is invalid with respect to MetricSeries
   */
  public static MetricSeries fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MetricSeries.class);
  }

  /**
   * Convert an instance of MetricSeries to an JSON string
   *
   * @return JSON string
   */
