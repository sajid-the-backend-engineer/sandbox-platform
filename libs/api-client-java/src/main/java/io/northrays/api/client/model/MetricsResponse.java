...
import io.northrays.api.client.model.MetricSeries;
...
public class MetricsResponse {
  ...
  public MetricsResponse series(@javax.annotation.Nonnull List<MetricSeries> series) {
    this.series = series;
    return this;
  }

  public MetricsResponse addSeriesItem(MetricSeries seriesItem) {
    if (this.series == null) {
  ...
  public void setSeries(@javax.annotation.Nonnull List<MetricSeries> series) {
    this.series = series;
  }
   ...
   * @return the MetricsResponse instance itself
   */
  public MetricsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.series, metricsResponse.series)&&
        Objects.equals(this.additionalProperties, metricsResponse.additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("series"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("series"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("series") != null) {
        ...
        for (int i = 0; i < jsonArrayseries.size(); i++) {
          MetricSeries.validateJsonElement(jsonArrayseries.get(i));
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MetricsResponse>() {
           ...
           public MetricsResponse read(JsonReader in) throws IOException {
             ...
             MetricsResponse instance = thisAdapter.fromJsonTree(jsonObj);
