...
public class Url {
   ...
   * @return the Url instance itself
   */
  public Url putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.url, url.url)&&
        Objects.equals(this.additionalProperties, url.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Url>() {
           ...
           public Url read(JsonReader in) throws IOException {
             ...
             Url instance = thisAdapter.fromJsonTree(jsonObj);
