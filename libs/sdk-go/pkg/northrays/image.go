...
// Example:
//
//	image := northrays.Base("ubuntu:22.04")
//	image := northrays.Base("python:3.11-slim")
//	image := northrays.Base("node:18-alpine")
...
//	WORKDIR /app`
//	image := northrays.FromDockerfile(dockerfile)
...
//
//	// Basic installation
//	image := northrays.Base("python:3.11").PipInstall([]string{"numpy", "pandas"})
//
//	// With options
...
// Example:
//
//	image := northrays.Base("ubuntu:22.04").AptGet([]string{"git", "curl", "build-essential"})
...
// Example:
//
//	image := northrays.Base("python:3.11").
//	    Env("PYTHONUNBUFFERED", "1").
...
// Example:
//
//	image := northrays.Base("python:3.11").PipInstall([]string{"numpy"})
