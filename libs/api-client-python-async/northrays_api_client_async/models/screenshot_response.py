...
class ScreenshotResponse(BaseModel):
    ...
    cursor_position: Optional[Dict[str, Any]] = Field(default=None, description="The current cursor position when the screenshot was taken", serialization_alias="cursorPosition")
