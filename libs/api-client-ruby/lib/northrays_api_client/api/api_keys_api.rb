...
module NorthraysApiClient
  class ApiKeysApi
    ...
    # @option opts [String] :x_northrays_organization_id Use with JWT to specify the organization ID
    ...
    def create_api_key_with_http_info(create_api_key, opts = {})
      ...
      header_params[:'X-Northrays-Organization-ID'] = opts[:'x_northrays_organization_id'] if !opts[:'x_northrays_organization_id'].nil?
