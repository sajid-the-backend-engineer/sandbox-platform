...
public class ProcessStatus {
   ...
   * @return the ProcessStatus instance itself
   */
  public ProcessStatus putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.autoRestart, processStatus.autoRestart) &&
        ...
        Objects.equals(this.additionalProperties, processStatus.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(autoRestart, pid, priority, running, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("autoRestart", "pid", "priority", "running"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProcessStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ProcessStatus is not found in the empty JSON string", ProcessStatus.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProcessStatus>() {
           ...
           public ProcessStatus read(JsonReader in) throws IOException {
             ...
             ProcessStatus instance = thisAdapter.fromJsonTree(jsonObj);
