...
public class Match {
  ...
  public Match line(@javax.annotation.Nonnull Integer line) {
    this.line = line;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Match match = (Match) o;
    return Objects.equals(this.content, match.content) &&
        Objects.equals(this._file, match._file) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(content, _file, line, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("content", "file", "line"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("content", "file", "line"));
  }
