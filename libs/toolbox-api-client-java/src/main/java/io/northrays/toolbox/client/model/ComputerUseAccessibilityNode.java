...
import io.northrays.toolbox.client.model.AccessibilityBounds;
...
public class ComputerUseAccessibilityNode {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("actions", "bounds", "children", "description", "id", "name", "role", "states"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ComputerUseAccessibilityNode.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ComputerUseAccessibilityNode is not found in the empty JSON string", ComputerUseAccessibilityNode.openapiRequiredFields.toString()));
        }
      }
