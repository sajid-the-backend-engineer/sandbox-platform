...
// checks if the NorthraysConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NorthraysConfiguration{}

// NorthraysConfiguration struct for NorthraysConfiguration
type NorthraysConfiguration struct {
	// Northrays version
...
type _NorthraysConfiguration NorthraysConfiguration

// NewNorthraysConfiguration instantiates a new NorthraysConfiguration object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewNorthraysConfiguration(version string, oidc OidcConfig, linkedAccountsEnabled bool, announcements map[string]Announcement, proxyTemplateUrl string, proxyToolboxUrl string, defaultSnapshot string, dashboardUrl string, maxAutoArchiveInterval float32, maintananceMode bool, environment string) *NorthraysConfiguration {
	this := NorthraysConfiguration{}
...
// NewNorthraysConfigurationWithDefaults instantiates a new NorthraysConfiguration object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewNorthraysConfigurationWithDefaults() *NorthraysConfiguration {
	this := NorthraysConfiguration{}
	return &this
}

// GetVersion returns the Version field value
func (o *NorthraysConfiguration) GetVersion() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *NorthraysConfiguration) GetVersionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NorthraysConfiguration) SetVersion(v string) {
	o.Version = v
}

// GetPosthog returns the Posthog field value if set, zero value otherwise.
func (o *NorthraysConfiguration) GetPosthog() PosthogConfig {
...
// and a boolean to check if the value has been set.
func (o *NorthraysConfiguration) GetPosthogOk() (*PosthogConfig, bool) {
	if o == nil || IsNil(o.Posthog) {
		return nil, false
	}
...
func (o *NorthraysConfiguration) HasPosthog() bool {
	if o != nil && !IsNil(o.Posthog) {
		return true
	}
...
func (o *NorthraysConfiguration) SetPosthog(v PosthogConfig) {
	o.Posthog = &v
}

// GetOidc returns the Oidc field value
func (o *NorthraysConfiguration) GetOidc() OidcConfig {
	if o == nil {
		var ret OidcConfig
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NorthraysConfiguration) GetOidcOk() (*OidcConfig, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Oidc, true
...
func (o *NorthraysConfiguration) SetOidc(v OidcConfig) {
	o.Oidc = v
}

// GetLinkedAccountsEnabled returns the LinkedAccountsEnabled field value
func (o *NorthraysConfiguration) GetLinkedAccountsEnabled() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NorthraysConfiguration) GetLinkedAccountsEnabledOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NorthraysConfiguration) SetLinkedAccountsEnabled(v bool) {
	o.LinkedAccountsEnabled = v
}

// GetAnnouncements returns the Announcements field value
func (o *NorthraysConfiguration) GetAnnouncements() map[string]Announcement {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *NorthraysConfiguration) GetAnnouncementsOk() (*map[string]Announcement, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NorthraysConfiguration) SetAnnouncements(v map[string]Announcement) {
	o.Announcements = v
}

// GetPylonAppId returns the PylonAppId field value if set, zero value otherwise.
func (o *NorthraysConfiguration) GetPylonAppId() string {
...
// and a boolean to check if the value has been set.
func (o *NorthraysConfiguration) GetPylonAppIdOk() (*string, bool) {
	if o == nil || IsNil(o.PylonAppId) {
		return nil, false
	}
...
func (o *NorthraysConfiguration) HasPylonAppId() bool {
	if o != nil && !IsNil(o.PylonAppId) {
		return true
	}
...
func (o *NorthraysConfiguration) SetPylonAppId(v string) {
	o.PylonAppId = &v
}

// GetProxyTemplateUrl returns the ProxyTemplateUrl field value
func (o *NorthraysConfiguration) GetProxyTemplateUrl() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NorthraysConfiguration) GetProxyTemplateUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NorthraysConfiguration) SetProxyTemplateUrl(v string) {
	o.ProxyTemplateUrl = v
}

// GetProxyToolboxUrl returns the ProxyToolboxUrl field value
func (o *NorthraysConfiguration) GetProxyToolboxUrl() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NorthraysConfiguration) GetProxyToolboxUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NorthraysConfiguration) SetProxyToolboxUrl(v string) {
	o.ProxyToolboxUrl = v
}

// GetDefaultSnapshot returns the DefaultSnapshot field value
func (o *NorthraysConfiguration) GetDefaultSnapshot() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NorthraysConfiguration) GetDefaultSnapshotOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NorthraysConfiguration) SetDefaultSnapshot(v string) {
	o.DefaultSnapshot = v
}

// GetDashboardUrl returns the DashboardUrl field value
func (o *NorthraysConfiguration) GetDashboardUrl() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NorthraysConfiguration) GetDashboardUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NorthraysConfiguration) SetDashboardUrl(v string) {
	o.DashboardUrl = v
}

// GetMaxAutoArchiveInterval returns the MaxAutoArchiveInterval field value
func (o *NorthraysConfiguration) GetMaxAutoArchiveInterval() float32 {
	if o == nil {
		var ret float32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NorthraysConfiguration) GetMaxAutoArchiveIntervalOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NorthraysConfiguration) SetMaxAutoArchiveInterval(v float32) {
	o.MaxAutoArchiveInterval = v
}

// GetMaintananceMode returns the MaintananceMode field value
func (o *NorthraysConfiguration) GetMaintananceMode() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NorthraysConfiguration) GetMaintananceModeOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NorthraysConfiguration) SetMaintananceMode(v bool) {
	o.MaintananceMode = v
}

// GetEnvironment returns the Environment field value
func (o *NorthraysConfiguration) GetEnvironment() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NorthraysConfiguration) GetEnvironmentOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NorthraysConfiguration) SetEnvironment(v string) {
	o.Environment = v
}

// GetBillingApiUrl returns the BillingApiUrl field value if set, zero value otherwise.
func (o *NorthraysConfiguration) GetBillingApiUrl() string {
...
// and a boolean to check if the value has been set.
func (o *NorthraysConfiguration) GetBillingApiUrlOk() (*string, bool) {
	if o == nil || IsNil(o.BillingApiUrl) {
		return nil, false
	}
...
func (o *NorthraysConfiguration) HasBillingApiUrl() bool {
	if o != nil && !IsNil(o.BillingApiUrl) {
		return true
	}
...
func (o *NorthraysConfiguration) SetBillingApiUrl(v string) {
	o.BillingApiUrl = &v
}

// GetAnalyticsApiUrl returns the AnalyticsApiUrl field value if set, zero value otherwise.
func (o *NorthraysConfiguration) GetAnalyticsApiUrl() string {
...
// and a boolean to check if the value has been set.
func (o *NorthraysConfiguration) GetAnalyticsApiUrlOk() (*string, bool) {
	if o == nil || IsNil(o.AnalyticsApiUrl) {
		return nil, false
	}
...
func (o *NorthraysConfiguration) HasAnalyticsApiUrl() bool {
	if o != nil && !IsNil(o.AnalyticsApiUrl) {
		return true
	}
...
func (o *NorthraysConfiguration) SetAnalyticsApiUrl(v string) {
	o.AnalyticsApiUrl = &v
}

// GetSshGatewayCommand returns the SshGatewayCommand field value if set, zero value otherwise.
func (o *NorthraysConfiguration) GetSshGatewayCommand() string {
...
// and a boolean to check if the value has been set.
func (o *NorthraysConfiguration) GetSshGatewayCommandOk() (*string, bool) {
	if o == nil || IsNil(o.SshGatewayCommand) {
		return nil, false
	}
...
func (o *NorthraysConfiguration) HasSshGatewayCommand() bool {
	if o != nil && !IsNil(o.SshGatewayCommand) {
		return true
	}
...
func (o *NorthraysConfiguration) SetSshGatewayCommand(v string) {
	o.SshGatewayCommand = &v
}

// GetSshGatewayPublicKey returns the SshGatewayPublicKey field value if set, zero value otherwise.
func (o *NorthraysConfiguration) GetSshGatewayPublicKey() string {
...
// and a boolean to check if the value has been set.
func (o *NorthraysConfiguration) GetSshGatewayPublicKeyOk() (*string, bool) {
	if o == nil || IsNil(o.SshGatewayPublicKey) {
		return nil, false
	}
...
func (o *NorthraysConfiguration) HasSshGatewayPublicKey() bool {
	if o != nil && !IsNil(o.SshGatewayPublicKey) {
		return true
	}
...
func (o *NorthraysConfiguration) SetSshGatewayPublicKey(v string) {
	o.SshGatewayPublicKey = &v
}

// GetRateLimit returns the RateLimit field value if set, zero value otherwise.
func (o *NorthraysConfiguration) GetRateLimit() RateLimitConfig {
...
// and a boolean to check if the value has been set.
func (o *NorthraysConfiguration) GetRateLimitOk() (*RateLimitConfig, bool) {
	if o == nil || IsNil(o.RateLimit) {
		return nil, false
	}
...
func (o *NorthraysConfiguration) HasRateLimit() bool {
	if o != nil && !IsNil(o.RateLimit) {
		return true
	}
...
func (o *NorthraysConfiguration) SetRateLimit(v RateLimitConfig) {
	o.RateLimit = &v
}
...
func (o NorthraysConfiguration) ToMap() (map[string]interface{}, error) {
...
func (o *NorthraysConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	varNorthraysConfiguration := _NorthraysConfiguration{}

	err = json.Unmarshal(data, &varNorthraysConfiguration)

	if err != nil {
		return err
	}

	*o = NorthraysConfiguration(varNorthraysConfiguration)
...
type NullableNorthraysConfiguration struct {
	value *NorthraysConfiguration
	isSet bool
}

func (v NullableNorthraysConfiguration) Get() *NorthraysConfiguration {
	return v.value
}

func (v *NullableNorthraysConfiguration) Set(val *NorthraysConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableNorthraysConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableNorthraysConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNorthraysConfiguration(val *NorthraysConfiguration) *NullableNorthraysConfiguration {
	return &NullableNorthraysConfiguration{value: val, isSet: true}
}

func (v NullableNorthraysConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNorthraysConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
