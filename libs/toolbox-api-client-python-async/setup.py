...
NAME = "northrays_toolbox_api_client_async"
VERSION = "0.0.0-dev"
PYTHON_REQUIRES = ">= 3.9"
REQUIRES = [
...
setup(
    name=NAME,
    version=VERSION,
    description="Northrays Toolbox API",
    author="OpenAPI Generator community",
    author_email="team@openapitools.org",
    url="",
    keywords=["OpenAPI", "OpenAPI-Generator", "Northrays Toolbox API"],
    ...
    Northrays Toolbox API. The base URL comes from the sandbox&#39;s &#x60;toolboxProxyUrl&#x60; field (returned in sandbox DTO by the main Northrays API) plus the sandbox ID: &#x60;{toolboxProxyUrl}/{sandboxId}/{endpoint}&#x60;. Default for Northrays Cloud: &#x60;https://proxy.app.northrays.com/toolbox/{sandboxId}&#x60;.
    """,  # noqa: E501
    package_data={"northrays_toolbox_api_client_async": ["py.typed"]},
)
