...
class ProcessApi:
    ...
    async def get_entrypoint_logs(
        ...
        _param = self._get_entrypoint_logs_serialize(
            follow=follow,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def get_entrypoint_logs_with_http_info(
        self,
        follow: Annotated[Optional[StrictBool], Field(description="Follow logs in real-time (WebSocket only)")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_entrypoint_logs_without_preload_content(
        self,
        follow: Annotated[Optional[StrictBool], Field(description="Follow logs in real-time (WebSocket only)")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_entrypoint_logs_serialize(
        self,
        follow,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/process/session/entrypoint/logs',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_entrypoint_session(
        ...
        _param = self._get_entrypoint_session_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def get_entrypoint_session_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_entrypoint_session_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_entrypoint_session_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/process/session/entrypoint',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def send_input(
        ...
        session_id: Annotated[StrictStr, Field(description="Session ID")],
        command_id: Annotated[StrictStr, Field(description="Command ID")],
        request: Annotated[SessionSendInputRequest, Field(description="Input send request")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type request: SessionSendInputRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._send_input_serialize(
            session_id=session_id,
            command_id=command_id,
            request=request,
            _request_auth=_request_auth,
    ...
    @validate_call
    async def send_input_with_http_info(
        self,
        session_id: Annotated[StrictStr, Field(description="Session ID")],
        command_id: Annotated[StrictStr, Field(description="Command ID")],
        request: Annotated[SessionSendInputRequest, Field(description="Input send request")],
    ...
    @validate_call
    async def send_input_without_preload_content(
        self,
        session_id: Annotated[StrictStr, Field(description="Session ID")],
        command_id: Annotated[StrictStr, Field(description="Command ID")],
        request: Annotated[SessionSendInputRequest, Field(description="Input send request")],
    ...
    def _send_input_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/process/session/{sessionId}/command/{commandId}/input',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
